...
('a1000001-0000-0000-0000-000000000001', 'Paris', 'France', 'Europe', 48.85660000, 2.35220000, 4, 95, 'City of Light — world-class art, cuisine, and romance'),
('a1000001-0000-0000-0000-000000000002', 'Tokyo', 'Japan', 'Asia', 35.68940000, 139.69170000, 4, 92, 'A vibrant blend of ultramodern and traditional culture'),
('a1000001-0000-0000-0000-000000000003', 'New York', 'USA', 'North America', 40.71280000, -74.00600000, 5, 94, 'The city that never sleeps — iconic skyline and Broadway'),
('a1000001-0000-0000-0000-000000000004', 'Bangkok', 'Thailand', 'Asia', 13.75630000, 100.50180000, 2, 88, 'Street food capital with ornate temples and nightlife'),
('a1000001-0000-0000-0000-000000000005', 'London', 'UK', 'Europe', 51.50740000, -0.12780000, 5, 93, 'Historic landmarks, royal palaces, and world-class museums'),
('a1000001-0000-0000-0000-000000000006', 'Dubai', 'UAE', 'Middle East', 25.20480000, 55.27080000, 4, 89, 'Futuristic skyline, luxury shopping, and desert adventures'),
('a1000001-0000-0000-0000-000000000007', 'Rome', 'Italy', 'Europe', 41.90280000, 12.49640000, 3, 90, 'Ancient ruins, Renaissance art, and world-famous pasta'),
('a1000001-0000-0000-0000-000000000008', 'Bali', 'Indonesia', 'Asia', -8.34050000, 115.09200000, 2, 87, 'Tropical paradise with rice terraces and surf beaches'),
('a1000001-0000-0000-0000-000000000009', 'Barcelona', 'Spain', 'Europe', 41.38510000, 2.17340000, 3, 86, 'Gaudi architecture, beaches, and vibrant nightlife'),
('a1000001-0000-0000-0000-000000000010', 'Istanbul', 'Turkey', 'Europe', 41.00820000, 28.97840000, 2, 84, 'Where East meets West — bazaars, mosques, and history'),
('a1000001-0000-0000-0000-000000000011', 'Sydney', 'Australia', 'Oceania', -33.86880000, 151.20930000, 4, 85, 'Harbour Bridge, Opera House, and stunning beaches'),
('a1000001-0000-0000-0000-000000000012', 'Cape Town', 'South Africa', 'Africa', -33.92490000, 18.42410000, 2, 80, 'Table Mountain, vineyards, and diverse wildlife'),
('a1000001-0000-0000-0000-000000000013', 'Amsterdam', 'Netherlands', 'Europe', 52.36760000, 4.90420000, 4, 83, 'Canals, cycling culture, and world-class museums'),
('a1000001-0000-0000-0000-000000000014', 'Singapore', 'Singapore', 'Asia', 1.35210000, 103.81980000, 4, 86, 'Garden city with futuristic architecture and hawker food'),
('a1000001-0000-0000-0000-000000000015', 'Lisbon', 'Portugal', 'Europe', 38.72230000, -9.13930000, 2, 82, 'Pastel-colored hills, tram rides, and fresh seafood'),
('a1000001-0000-0000-0000-000000000016', 'Delhi', 'India', 'Asia', 28.70410000, 77.10250000, 1, 78, 'Historic monuments, street food, and vibrant bazaars'),
('a1000001-0000-0000-0000-000000000017', 'Mumbai', 'India', 'Asia', 19.07600000, 72.87770000, 2, 79, 'Bollywood, marine drive, and the gateway of India'),
('a1000001-0000-0000-0000-000000000018', 'Jaipur', 'India', 'Asia', 26.91240000, 75.78730000, 1, 81, 'The Pink City — forts, palaces, and colorful markets'),
('a1000001-0000-0000-0000-000000000019', 'Goa', 'India', 'Asia', 15.29930000, 74.12400000, 1, 85, 'Sun-kissed beaches, Portuguese heritage, and nightlife'),
('a1000001-0000-0000-0000-000000000020', 'Varanasi', 'India', 'Asia', 25.31760000, 83.01400000, 1, 76, 'Spiritual capital of India — ghats and ancient temples'),
('a1000001-0000-0000-0000-000000000021', 'Udaipur', 'India', 'Asia', 24.58540000, 73.71250000, 1, 80, 'City of Lakes — romantic palaces and boat rides'),
('a1000001-0000-0000-0000-000000000022', 'Manali', 'India', 'Asia', 32.23960000, 77.18870000, 1, 82, 'Mountain town with adventure sports and snow valleys'),
('a1000001-0000-0000-0000-000000000023', 'Rishikesh', 'India', 'Asia', 30.08690000, 78.26760000, 1, 77, 'Yoga capital with river rafting and ashrams'),
('a1000001-0000-0000-0000-000000000024', 'Prague', 'Czech Republic', 'Europe', 50.07550000, 14.43780000, 2, 83, 'Gothic spires, cobblestone lanes, and craft beer'),
('a1000001-0000-0000-0000-000000000025', 'Kyoto', 'Japan', 'Asia', 35.01160000, 135.76810000, 3, 84, 'Traditional temples, bamboo forests, and geisha culture'),
('a1000001-0000-0000-0000-000000000026', 'Marrakech', 'Morocco', 'Africa', 31.62950000, -7.98110000, 2, 79, 'Colorful souks, riads, and Sahara gateway'),
('a1000001-0000-0000-0000-000000000027', 'Seoul', 'South Korea', 'Asia', 37.56650000, 126.97800000, 3, 85, 'K-pop culture, palaces, and street food paradise'),
('a1000001-0000-0000-0000-000000000028', 'Vienna', 'Austria', 'Europe', 48.20820000, 16.37380000, 3, 81, 'Imperial palaces, classical music, and Viennese coffee'),
('a1000001-0000-0000-0000-000000000029', 'Hanoi', 'Vietnam', 'Asia', 21.02780000, 105.83420000, 1, 80, 'Old quarter charm, pho, and motorbike madness'),
('a1000001-0000-0000-0000-000000000030', 'Cairo', 'Egypt', 'Africa', 30.04440000, 31.23570000, 1, 82, 'Pyramids, Sphinx, and ancient Egyptian history'),
